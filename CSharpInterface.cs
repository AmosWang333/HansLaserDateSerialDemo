...
{
    public static class CSharpInterface
    {
        /************************************************************************/
        /*  ①引入C++动态链接库的函数
        /************************************************************************/
        ...
        [DllImport("HansAdvInterface.dll", EntryPoint = "HS_GetObjProperty",
            CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern int HS_GetObjProperty(ref double pLeft, ref double pTop, ref double pRight,
            ref double pBottom);

        [DllImport("HansAdvInterface.dll", EntryPoint = "HS_AddBarcode",
            CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern int HS_AddBarcode(string lpszStr, int nBarType, double dbHeight, double dbPosX,
            double dbPosY,
            double dbAngle, int nAlign, int nLayerNo, double dbBarRatio, double dbLineDist, double dbShrink,
            bool bReverse,
        ...
        [DllImport("HansAdvInterface.dll", EntryPoint = "HS_AddCurve",
            CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern int HS_AddCurve(double[,] ptBuf, int nPtNum, int nLayer, bool bHatch, int nHatchLayer,
            string lpszObjName);
        ...
        public static extern int HS_ImportImageFile(string lpszFileName, double dbPosX, double dbPosY, double dbWidth,
            double dbHeight, double dbRotate, int nMarkType, double dbDotDistX, double dbDotDistY, int nAccDot,
            bool bReciprocate,
    ...
    {
        [MarshalAs(UnmanagedType.Bool)] public bool bEnable; //填充使能
        [MarshalAs(UnmanagedType.Bool)] public bool bEquaDist; //等间距使能
        [MarshalAs(UnmanagedType.Bool)] public bool bKeepAngle; //填充线绕轮廓旋转
        [MarshalAs(UnmanagedType.U4)] public int nFillStyle; //填充类型
        [MarshalAs(UnmanagedType.R8)] public double dbSpace; //填充间距
        [MarshalAs(UnmanagedType.R8)] public double dbAngle; //填充角度
        [MarshalAs(UnmanagedType.R8)] public double dbBeamComp; //光栅大小
        [MarshalAs(UnmanagedType.R8)] public double dbLineReduce; //线缩进量
        [MarshalAs(UnmanagedType.R8)] public double dbStartOffset; //起始缩进量
        [MarshalAs(UnmanagedType.R8)] public double dbEndOffset; //末尾缩进量
        [MarshalAs(UnmanagedType.R8)] public double dbMinJump; //最小跳转间距
        [MarshalAs(UnmanagedType.Bool)] public bool bLoop; //缩扩使能
        [MarshalAs(UnmanagedType.U4)] public int nLoopNum; //缩扩圈数
        [MarshalAs(UnmanagedType.R8)] public double dbLoopDist; //缩扩间距
        [MarshalAs(UnmanagedType.Bool)] public bool bRemoveLine; //缩扩后去掉填充线
        [MarshalAs(UnmanagedType.Bool)] public bool bRemoveOrg; //缩扩后去掉原始轮廓
        [MarshalAs(UnmanagedType.U4)] public int nFillNum; //填充次数
        [MarshalAs(UnmanagedType.R8)] public double ProAngle; //累进角度
        [MarshalAs(UnmanagedType.R8)] public double AddDis; //累进间距
        [MarshalAs(UnmanagedType.Bool)] public bool bSaveCountour; //填充后保留外框
    };

    [StructLayout(LayoutKind.Sequential)]
    public struct HATCHPARA
    {
        [MarshalAs(UnmanagedType.Struct)] public BaseHatch newFileData1;
        [MarshalAs(UnmanagedType.Struct)] public BaseHatch newFileData2;
        [MarshalAs(UnmanagedType.Bool)] public bool bFillFirst;
    };
    ...
    {
        [MarshalAs(UnmanagedType.U4)] public int naFontType; //字体类型 0-TTF，1-SHX，2-HANS，3-DOT
        [MarshalAs(UnmanagedType.U1)] public Byte nCharSet; //字符集,Unicode编码时用
    ...
    {
        [MarshalAs(UnmanagedType.U4)] public int lfHeight;
        [MarshalAs(UnmanagedType.U4)] public int llfWidth;
        [MarshalAs(UnmanagedType.U4)] public int llfEscapement;
        [MarshalAs(UnmanagedType.U4)] public int llfOrientation;
        [MarshalAs(UnmanagedType.U4)] public int llfWeight;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfItalic;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfUnderline;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfStrikeOut;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfCharSet;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfOutPrecision;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfClipPrecision;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfQuality;
        [MarshalAs(UnmanagedType.U1)] public System.Byte lfPitchAndFamily;
    ...
    {
        [MarshalAs(UnmanagedType.U4)] public int nCount; //打标次数
        [MarshalAs(UnmanagedType.R8)] public double dbMarkV; //矢量打标速度(mm/s)
        [MarshalAs(UnmanagedType.R8)] public double dbJumpV; //矢量空跳速度(mm/s)
        [MarshalAs(UnmanagedType.R8)] public double dbQFre; //Q频(KHz)
        [MarshalAs(UnmanagedType.R8)] public double dbQRls; //Q释放(us)
        [MarshalAs(UnmanagedType.R8)] public double dbCurrent; //电流(A)
        [MarshalAs(UnmanagedType.U4)] public int nFpkTime; //首脉冲抑制时间	
        [MarshalAs(UnmanagedType.R8)] public double dbFPKInitRate; //首点比例(0.0~1.0)	
        [MarshalAs(UnmanagedType.R8)] public double dbFPKLenRate; //抑制长度系数(0.0~0.999)
        [MarshalAs(UnmanagedType.R8)] public double dbFPKMaxPRate; //峰值能量比例(0.0~1.0)
        [MarshalAs(UnmanagedType.R8)] public double dbFPKCurRate; //首脉冲电流系数(0.0~1.0)
        [MarshalAs(UnmanagedType.U4)] public int nQuality; //打标质量系数
        [MarshalAs(UnmanagedType.U4)] public int nLayerDelay; //层延时
        [MarshalAs(UnmanagedType.U4)] public int nLaserOnDelay; //激光开延时(us)
        [MarshalAs(UnmanagedType.U4)] public int nLaserOffDelay; //激光关延时(us)
        [MarshalAs(UnmanagedType.U4)] public int nMoveLineDelay; //走笔延时(us)
        [MarshalAs(UnmanagedType.U4)] public int nJumpDelay; //跳转延时(us)
        [MarshalAs(UnmanagedType.U4)] public int nRoundDelay; //拐弯延时(us)
        [MarshalAs(UnmanagedType.R8)] public double dbCurrentR; //电流(%)
        [MarshalAs(UnmanagedType.R8)] public double dbSimmerCur; //维持电流(%)
        [MarshalAs(UnmanagedType.U4)] public int nWaveForm; //波形
        [MarshalAs(UnmanagedType.R8)] public double dbPowerR; //功率(%)
    };
    ...
    {
        [MarshalAs(UnmanagedType.U2)] public ushort nVer; //版本号,预留0
        [MarshalAs(UnmanagedType.U2)] public ushort nAxis; //轴号
        [MarshalAs(UnmanagedType.U2)] public ushort nMoveMode; //运动模式:0-绝对运动,1-相对运动
        [MarshalAs(UnmanagedType.U4)] public int nMovePos; //运动量或位置
        [MarshalAs(UnmanagedType.U4)] public System.UInt32 nMoveSpeed; //运动速度(脉冲/秒)
        [MarshalAs(UnmanagedType.U4)] public System.UInt32 nMoveAcc; //加速度(递增脉冲/秒)
        [MarshalAs(UnmanagedType.U4)] public System.UInt32 nDelay; //运动后延时
    };
    ...
    {
        [MarshalAs(UnmanagedType.R8)] public double x; //x
        [MarshalAs(UnmanagedType.R8)] public double y; //y
        [MarshalAs(UnmanagedType.R8)] public double z; //z (3D预留)
    };
